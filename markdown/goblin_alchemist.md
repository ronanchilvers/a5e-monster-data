...
actions:
    ...
    - { name: 'Throw Vial', desc: "Ranged Weapon Attack: +3 to hit, range 20/40 ft., one target. Hit: 3 (1d6) ongoing fire damage. A creature can use an action to douse the fire on a target, ending all ongoing damage being dealt by alchemist's fire. (You can substitute acid by altering the damage type.)" }
'bonus actions':
